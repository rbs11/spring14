...
${OBJECTDIR}/rvm.o: rvm.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/rvm.o rvm.c

${OBJECTDIR}/segutilities.o: segutilities.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/segutilities.o segutilities.c

${OBJECTDIR}/transactutilities.o: transactutilities.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/transactutilities.o transactutilities.c
...
${TESTDIR}/tests/abort.o: tests/abort.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/abort.o tests/abort.c


${TESTDIR}/tests/basic.o: tests/basic.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/basic.o tests/basic.c


${TESTDIR}/tests/basic9.o: tests/basic9.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/basic9.o tests/basic9.c


${TESTDIR}/tests/fullbinary.o: tests/fullbinary.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/fullbinary.o tests/fullbinary.c


${TESTDIR}/tests/multi.o: tests/multi.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/multi.o tests/multi.c


${TESTDIR}/tests/multi-abort.o: tests/multi-abort.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/multi-abort.o tests/multi-abort.c


${TESTDIR}/tests/semantics_01.o: tests/semantics_01.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/semantics_01.o tests/semantics_01.c


${TESTDIR}/tests/semantics_02.o: tests/semantics_02.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/semantics_02.o tests/semantics_02.c


${TESTDIR}/tests/test1.o: tests/test1.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test1.o tests/test1.c


${TESTDIR}/tests/test2.o: tests/test2.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test2.o tests/test2.c


${TESTDIR}/tests/test3.o: tests/test3.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test3.o tests/test3.c


${TESTDIR}/tests/test4.o: tests/test4.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test4.o tests/test4.c


${TESTDIR}/tests/test5.o: tests/test5.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test5.o tests/test5.c


${TESTDIR}/tests/test_multi1.o: tests/test_multi1.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/test_multi1.o tests/test_multi1.c


${TESTDIR}/tests/truncate.o: tests/truncate.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/truncate.o tests/truncate.c
...
${OBJECTDIR}/rvm_nomain.o: ${OBJECTDIR}/rvm.o rvm.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/rvm_nomain.o rvm.c;\
	else  \
...
${OBJECTDIR}/segutilities_nomain.o: ${OBJECTDIR}/segutilities.o segutilities.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/segutilities_nomain.o segutilities.c;\
	else  \
...
${OBJECTDIR}/transactutilities_nomain.o: ${OBJECTDIR}/transactutilities.o transactutilities.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/transactutilities_nomain.o transactutilities.c;\
	else  \
...
${OBJECTDIR}/utilities_nomain.o: ${OBJECTDIR}/utilities.o utilities.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/utilities_nomain.o utilities.c;\
	else  \
